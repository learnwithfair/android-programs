...
public class Part6SqliteShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part6_sqlite_show_all);
        this.setTitle("All Account Info");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LinearLayout linearLayout = findViewById(R.id.Part6SqliteShowAllActivityId);
        if (loadBackgroundColor()!=getResources().getColor(R.color.background_color)){
            linearLayout.setBackgroundColor(loadBackgroundColor());
        }
        listView = findViewById(R.id.part6sqliteShowAlllistViewId);
        info = new ArrayList();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Part6SqliteShowAllActivity.this, values, Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
